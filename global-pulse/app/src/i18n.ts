...
export const DICT = {
  es: {
    ...
    trends: 'Tendencias',
    trendsWindow: 'ventana',
    trendsDays: 'días',
    trendsStatus: 'Estado actual',
    trendsRecent: 'Nodos recientes',
    trendsNodes: 'nodos en el periodo',
    trendsUpdated: 'Actualizado',
    trendsEmpty: 'Sin nodos en el periodo.',
  ...
  en: {
    ...
    trendsWindow: 'window',
    trendsDays: 'days',
    trendsStatus: 'Current status',
    trendsRecent: 'Recent nodes',
    trendsNodes: 'nodes in the period',
    trendsUpdated: 'Updated',
    trendsEmpty: 'No nodes in the period.',
