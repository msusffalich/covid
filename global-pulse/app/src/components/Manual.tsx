    ...
    sections: [
      ...
      { h: '3. Vistas: Mapa, Grafo y Lista',
        p: ['Mapa: cada círculo es un nodo situado donde ocurre el evento. Su color indica la categoría y su tamaño el impacto; el halo pulsante señala que pertenece al pulso vigente.',
            ...
            'Tendencias: sigue automáticamente 6 temas permanentes (Irán–EE.UU., Rusia–Ucrania, Gaza/Oriente Medio, IA, Impacto climático, Economía) con un resumen de evolución, una gráfica de impacto en el tiempo y los nodos recientes. Se actualiza solo cada día, sin necesidad de Obsidian.'] },
      { h: '4. Filtros y categorías',
        p: ['Filtra tocando las categorías (se pueden combinar varias) y por impacto mínimo con el deslizador. Los filtros se aplican a las tres vistas.',
            'Categorías: Geopolítica · Economía · Ciencia · Impacto climático (consecuencias del cambio climático: fenómenos extremos, emisiones, adaptación) · Tecnología · Innovación y dispositivos (productos, inventos y lanzamientos) · Salud y bienestar · Cultura y sociedad.'] },
      ...
      { h: '9. Global Brain: el segundo cerebro (Obsidian)',
        p: ['Global Pulse alimenta cada día una bóveda Obsidian llamada «Global Brain», organizada por el principio de Kardashev (K0 local · K1 planetario · K2 estelar/energía · K3 frontera cósmica) y el método PARA. Vive en el repositorio, en global-pulse/data/global-brain/, y el ciclo diario le añade automáticamente el pulso y las notas nuevas.',
            'Para usarla: clona el repositorio y abre la carpeta «Global Brain» como bóveda en Obsidian; instala los plugins Obsidian Git (auto-pull diario) y Dataview (índices dinámicos). Alternativas rápidas: los botones «⬇» de la app descargan el pulso o una nota individual; y GP_VAULT_DIR hace que el pipeline escriba directamente en una bóveda local.'] },
    ...
    sections: [
      ...
      { h: '3. Views: Map, Graph and List',
        p: ['Map: each circle is a node placed where the event happens. Its color is the category and its size the impact; the pulsing halo marks nodes in the current pulse.',
            ...
            'Trends: automatically tracks 6 permanent themes (Iran–USA, Russia–Ukraine, Gaza/Middle East, AI, Climate impact, Economy) with an evolution summary, an impact-over-time chart and recent nodes. It updates by itself every day, with no need for Obsidian.'] },
      { h: '4. Filters and categories',
        p: ['Filter by tapping categories (several can be combined) and by minimum impact with the slider. Filters apply to all three views.',
            'Categories: Geopolitics · Economy · Science · Climate impact (consequences of climate change: extreme events, emissions, adaptation) · Technology · Innovation & devices (products, inventions and launches) · Health & wellness · Culture & society.'] },
      ...
      { h: '9. Global Brain: the second brain (Obsidian)',
        p: ['Global Pulse feeds a daily Obsidian vault called "Global Brain", organized by the Kardashev principle (K0 local · K1 planetary · K2 stellar/energy · K3 cosmic frontier) and the PARA method. It lives in the repository at global-pulse/data/global-brain/, and the daily cycle automatically adds the pulse and new notes.',
            'To use it: clone the repository and open the "Global Brain" folder as a vault in Obsidian; install the Obsidian Git plugin (daily auto-pull) and Dataview (dynamic indexes). Quick alternatives: the app’s "⬇" buttons download the pulse or a single note; and GP_VAULT_DIR makes the pipeline write directly into a local vault.'] },
      { h: '10. About the demo',
