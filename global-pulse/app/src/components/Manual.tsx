...
const MANUAL: Record<'es' | 'en', { title: string; sections: Section[] }> = {
  es: {
    ...
    sections: [
      ...
      { h: '4. Filtros',
        p: ['Filtra por categoría (geopolítica, economía, ciencia, clima, tecnología, sociedad) y por impacto mínimo con el deslizador. Los filtros se aplican a las tres vistas.'] },
      ...
      { h: '9. Nota sobre la demostración',
  ...
  en: {
    ...
    sections: [
      ...
      { h: '4. Filters',
        p: ['Filter by category (geopolitics, economy, science, climate, technology, society) and by minimum impact with the slider. Filters apply to all three views.'] },
